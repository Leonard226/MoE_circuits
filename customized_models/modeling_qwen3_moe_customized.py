...
class Qwen3MoeAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        hook_before_matmul_wo = attn_output #### added, shape: [batch_size, num_tokens, num_heads, head_dim]
        attn_output = attn_output.reshape(*input_shape, -1).contiguous()
        attn_output = self.o_proj(attn_output)
        attn_hooks = (hook_q, hook_k, hook_v, None, None, hook_attn_weights, hook_before_matmul_wo) #### added
        return attn_output, attn_weights, attn_hooks #### added
...
class Qwen3MoeDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        # Self Attention
        hidden_states, self_attn_weights, attn_hooks = self.self_attn(
...
#### added
        ...
        n_head_dim = self.config.head_dim
        ...
        hook_k = torch.empty((n_layers, batch_size, n_kv_heads, n_tokens, n_head_dim)) # different from olmoe
        ...
        hook_before_matmul_wo = torch.empty((n_layers, batch_size, n_tokens, n_heads, n_head_dim)) # different from olmoe
