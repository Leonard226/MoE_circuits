...
class OlmoeAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # print(value_states[0,0,:3]) #### added, for test
        # exit() #### added, for test
        ...
        # print("attn score * v",attn_output[0,0,0,:3]) #### added, for test
        # exit() #### added, for test
        #### added, checker
        ...
        # print('aout', attn_output[1,0,:3]) #### added, for test
...
class OlmoeDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # print(hidden_states[0,0,:3]) #### added, for test
        # exit() #### added, for test
        # Self Attention
        ...
        hidden_states, router_logits, mlp_hooks = self.mlp(hidden_states) #### modified
